    ...
    <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center p-4 z-50">
      <div className="bg-gray-900 text-white rounded-lg w-full max-w-2xl p-6 relative max-h-[90vh] overflow-y-auto overflow-x-hidden">
        ...
        <div className="mb-6">
          ...
          <div className="text-blue-500 text-2xl mb-4 flex items-center justify-start gap-4 flex-wrap">
            <span className="flex items-center gap-2">Read</span>
            <span className="text-gray-500">→</span>
            <span>Recall & Say</span>
            <span className="text-gray-500">→</span>
            <span className="flex items-center gap-2">Listen & Rate</span>
            <span className="text-gray-500">→</span>
            <span>Repeat</span>
          </div>
          <p className="text-gray-400 text-lg">
            Each time you go through this cycle, you're pushing both the sounds and active reading skills into your long-term memory. 
            With practice, you'll start recognizing these syllables instantly when you see them.
          </p>
        </div>

        <div className="mb-6">
          <h2 className="text-xl font-bold mb-4">Managing Your Stack</h2>
