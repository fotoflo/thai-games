  ...
  const letters = [
    {
      ...
      romanized: '(silent)',
      name: 'or aang (basin)',
      notes: 'Required as syllable starter when no other consonant begins the syllable'
    },
    {
      thai: 'ย',
      type: 'Consonant',
    ...
    <Card className="w-full max-w-2xl">
      <CardHeader>
        <CardTitle className="flex items-center gap-4">
          ...
          <span className="text-xl text-gray-500">"to want"</span>
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-6">
            ...
            {letters.map((letter, idx) => (
              <div key={idx} className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="space-y-1 text-sm">
                  <p><span className="font-semibold">Name:</span> {letter.name}</p>
                  <p><span className="font-semibold">Type:</span> {letter.type}</p>
                  <p><span className="font-semibold">Class:</span> {letter.class}</p>
                  <p><span className="font-semibold">Value:</span> {letter.value}</p>
                  <p><span className="font-semibold">In romanization:</span> {letter.romanized}</p>
        ...
        <div>
          ...
          <div className="space-y-2 text-gray-700">
            <p>• The spelling อยา is a compound form representing the sound /yaa/</p>
            <p>• The initial อ is silent but required by Thai spelling rules</p>
            <p>• The final ก (k) creates a "dead" syllable, affecting the tone</p>
